...
// To parse this JSON data, do
//
//     final searchWeatherModel = searchWeatherModelFromJson(jsonString);

// To parse this JSON data, do
//
//     final searchWeatherModel = searchWeatherModelFromJson(jsonString);

List<SearchWeatherModel> searchWeatherModelFromJson(String str) =>
    List<SearchWeatherModel>.from(
        json.decode(str).map((x) => SearchWeatherModel.fromJson(x)));

String searchWeatherModelToJson(List<SearchWeatherModel> data) =>
